...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        food_comments = [
            "еда была невероятно вкусной", "блюда оставили желать лучшего", "вкусная еда, но порции маленькие",
            "кухня на высоте", "еда была пересоленной", "всё свежее и аппетитное", "неплохая кухня, но ожидал большего"
        ]
        service_comments = [
            "обслуживание на высшем уровне", "официанты были медленными", "персонал очень вежливый",
            "сервис оставил неприятное впечатление", "официанты забывали заказы", "быстрое и качественное обслуживание"
        ]
        atmosphere_comments = [
            "атмосфера уютная и тёплая", "слишком шумно", "интерьер потрясающий", "чувствуется какая-то холодность",
        ...
        price_comments = [
            ...
            "цены кусаются", "ожидал меньший счёт"
        ]
